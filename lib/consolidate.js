...
exports.swiger = fromStringRenderer('swiger');

/**
 * Swiger string support.
 */

exports.swiger.render = function(str, options, fn){
  return promisify(fn, function(fn) {
    var engine = requires.swiger || (requires.swiger = require('swiger'));
